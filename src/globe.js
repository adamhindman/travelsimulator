export let globe = [
  ...
  },
  {
    ...
    objects:[
      {name:"R'LYEH", article:"", description:"You awake from a night of troubled dreams. In that fitful slumber, you fled through a malovolent city of cyclopean stone architecture, sunk miles below the sea. For what seemed an endless lifetime, you ran in terror from the dread that sought you, along shadow-haunted avenues lined with piles of inhuman bones, and rune-carved tombs pledged to mindless gods from an unremembered age, and treasuries gorged with blood-drenched lucre, and windowless mansions from whose edifices teemed a fell and noisome black ooze, luminous with obisidian light and flowing in angry octopine tendrils. These eldritch structures, hewn by sightless slaves to the beating of a demon drum, climbed vertiginously toward the dim light of the dying sun, converging and diverging along their non-Euclidean lengths, in an impossible geometry that trembled your fevered brain with the curse-begotten knowledge that an inexhaustible horror waits, forever, pressing against the very walls of reason with mute, pitiless patience.</p><p>After brushing you teeth, you head down to the hotel breakfast bar for some complimentary cereal, then take a boat out to Nan Madol to tour the deserted ruins there."},
    // {name:"", article:"", description:""}
    ],
  },
  {
