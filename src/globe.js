export let globe = [
  ...
  `,
    ...
    objects: [
      ...
      },
      {
        ...
        article: "A",
        description:
          "A tool for scoring goals in hockey. Traditionally made of wood, modern hockey sticks are now constructed of lightweight allows and composite materials, often laminated layers of graphene and tungsten, with a fiber optic core for increased bandwidth on the ice.",
      },
      {
        name: "TIMBITS",
        article: "A box of",
  ...
  },
  {
    ...
    objects: [
      ...
      {
        name: "REINDEER",
        article: "A vast herd of reindeer",
        description:
  ...
  },
  {
    ...
    objects: [
      { name: "GOLDHORN", article: "The ", description: "While hiking around on Mt. Triglav in the Julian Alps, you encounter the Goldhorn buck. This legendary ibex has magical powers, including the ability to live forever, and a set of horns so bright gold in color that they can temporarily blind you. " },
      { name: "CERKVENIK BRIDGE", article: "The", description: "\"You shall not... pass!\"</p><p>\"You shall... not pass!\"</p><p>\"You ... shall not pass!\"</p><p>You stand at the edge of the underground bridge, watching tourists take selfies of themselves pretending to be someone named Gandalf. They're grimacing, pretending to hold up a wizard staff. </p><p>Below them, hundreds of feet of empty space plunges to into the stygian depths below. The Skocjan cave system is gigantic, \"the underground grand canyon\", and this narrow bridge in Martel Chamber is the only way across a 70-foot wide fissure carved from stone by the Reka river, millions of years ago.</p><p>\"You ... shall... not... pass!\"</p><p>One of the tourists asks you to take their picture, and you happily oblige them. Afterwards, they ask if you want them to take your picture while you say the line. You shake your head, and tell them that you're not much of a Star Trek fan." },
      // { name: "", article: "", description: "" },
    ],
  },
  {
