export let globe = [
  {
    ...
    objects: [
      ...
      },
      {
        ...
        article: "A",
        description:
          "<p>You notice a small, handheld teleporter on the \'ground\' here<sup>1</sup>. It has a rotary dial with every country on Earth printed on it in very small letters, and it looks like you could turn the dial to any of them to select it.</p><p>In a triumph of user-centered design, the device has a single, intuitive button that just says TELEPORT on it.</p><p><sup>1</sup><span class=\"dim\">&nbsp;To be honest, it's not the ground, <em>per se</em>, since there is no up or down in this space (which is more like a metapositional interstitice than a place), nor are there any solid, tangible surfaces for it to be \'on\'. If asked to be precise, you'd have to say that the teleportation device exists as a cloud of overlapping probability manifolds that you can reach out and collapse to <em>create</em> a teleportation device if you choose to. Which you do.</p></span>",
        inventoryItem: {
          name: "Handheld Teleporter",
          description:
