export let globe = [
  ...
  },
  {
    ...
    objects: [
      ...
      {name:"GUINNESS", article:"Some", description:"<p></p>You wake up in a jail cell. You are tired, hungry, drunk, and malnourished. You recall glimpses of yourself, careening through the streets of Dublin in a fugue state, wearing a white sheet and claiming to be \"the ghost of Leopold Bloom\". You pronounce it \"Blooooooom\", in a ghostly voice, while shaking your arms. You feel like you've been beaten up, and the police officer tells you you thrown in jail for public drunkenness.</p><p>That evening, in the hotel room, you feel a lot better. You'd had a serious craving for cold, clear water, beef, potatoes, and carrots, and fresh bread with butter. You ate it like a shipwreck survivor found floating in the sea.</p><p>You look through your journal. The last entry is from a week ago, and it reads: </p>\"<em>Guinness has been brewed in Dublin since 1759, and is the most popular alcoholic drink in Ireland. It is packed with antioxidants, B vitamins, iron, and fiber. Locals say it's so nutritious, a person can easily survive on a diet consisting solely of this dry, dark brown stout. Sounds like a challenge!</em>\""},
    ],
  },
  {
    area: "Israel",
