export let globe = [
  ...
  },
  {
    ...
    attribution: "Photo by <a target='_blank' href='https://unsplash.com/@stephsmith?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText'>Steph Smith</a> on <a href='https://unsplash.com/s/photos/bosnia-and-herzegovina?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText' target='_blank'>Unsplash</a>",
    type: "country",
  ...
  },
  {
    ...
    objects:[
      {name:"TANK GRAVEYARD", article:"", description: "You wander beside a mountain of twisted, rusted steel. Tanks and other military equipment, most of it bearing a hammer and sickle logo, has been arranged here as memorial of the long and bloody war between Ethiopia and Eritrea."},
    // {name:"", article:"", description:""},
    // {name:"", article:"", description:""}
    ],
  },
  ...
  },
  {
    ...
    objects:[
      ...
      {name:"TAJ MAHAL", article:"The", description:"You enjoy watching other tourists take selfies in front of this transcendent monument to love."},
      ...
      {name:"KARNI MATA TEMPLE", article:"The", description:"This temple contains 20,000 rats, which is not considered much of a problem, because the rats are the reincarnated souls of storytellers. Devotees at the temple feed the rats rich food, and sweep up after their leavings. Sounds like a pretty good life.</p>"},
    ],
  },
  {
    area: "Indonesia",
  ...
  },
  {
    ...
    objects: [
      { name: "WESTERN WALL", article: "The", description: "A sacred retaining wall in Jerusalem. You find it incredibly moving: all the rocks, stacked on top of each other, and so on. Bigger rocks than you expected. It is 62 feet tall. Truly, a wall to be proud of.</p><p>\"Could you please take a photo of me and the wall?\" you ask a tourist.</p><p>She snaps a picture of you. In the picture, you are pointing at the wall with a look on your face, like: \"that's that famous wall!\".</p><p>Then she asks you to take a picture of her in front of the wall, looking like she can't find the wall. In her picture, she is shrugging her shoulders, like: \"hey, anybody seen a wall around here?\" while her boyfriend scratches his head, looking equally confused.</p>" },
      { name: "JESUS TRAIL", article: "The", description: "A fairly new addition to Israel's hiking scene, the Jesus Trail follows the path Jesus Christ (a local religious figure of note) might have followed from his hometown of Nazareth to Capernaum. It's a distance of 40 miles, and can easily be accomplished in 4 days of pleasant hiking through this picturesque, semi-arid climate.</p><p>You pack lightly for the journey: a bottle of water, a loaf of bread, and a single fish, and find that by the end of the journey you've got several loaves and fishes left over, and your bottle of water has turned into wine.</p><p>" },
      { name: "ASHALIM POWER STATION", article: "The", description: "Ashalim Power Station has at its heart a massive solar furnace, rising like the tower of Barad-dûr from the flatness of the Negev desert, to a height of 260 meters. This tower blazes like the Eye of Sauron, too, as light from hundreds of robotically-controlled mirrors focus the heat of the sun into a solar collector at its head.</p>" },
    ],
  },
  {
    area: "Italy",
  ...
  },
  {
    ...
    objects:[
    {name: "GIRAFFE MANOR", article: "", description: "You wake up to find a giraffe leaning its long neck through the second-story window of your hotel room. You blink your eyes and look up at it. It stares down at you, with a funny look on its face that resembles a smile.</p><p></p><p>\"Hello.\" You give it a little wave. </p><p></p><p>It seems you were just a temporary distraction from its real genda: eating the leaves that grow on the branches of the tree outside your window. It backs out the window and returns to its breakfast, having satisfied all its curiousity about you when it realized you had no treats to give out. </p><p></p><p>You stand at the window and look out. This giraffe is not alone: there are two others working the nearby acacia trees. In the distance, you can see even more, drinking from a watering hole, or just standing around majestically in the golden light of the Kenyan morning.</p><p></p><p>You step up on the windowsill, and hop over to the acacia tree. Climbing up to the tallest branch, beyond the reach of even the giraffe's prodigious neck, you pull out fistfuls of the leaves. You assume that the leaves that grow out of reach of the giraffe are probably the most delicious leaves anyway, and that the friendly creature will appreciate them.</p><p></p><p>Holding the leaves against your chest with in one hand, you carefully make your way out to the end of a long branch. The branch seems a little thin, but is holding your weight so far. You look down at the ground, 25 feet below. It looks hard.</p><p></p><p>The giraffe steps back to watch you. It must be thinking you are a very strange creature, but since you are carrying some of the sweet, forbidden upper treetop leaves, perhaps you will feed it some of them. Here at Giraffe Manor, it is used to being hand fed by the humans who come to stay here, so it seems like a distinct possibility. It waits, patiently.</p><p></p><p>You wrap your legs around the end of the branch tightly, working your way further out. The branch is dipping now, under your weight. You extend your arm out as far as you can, offering some of the leaves to the creature. </p><p></p><p>It cranes its neck, and reaches out with its long tongue — well over a foot long — and delicately plucks the leaves out of your hand. Its tongue is wet, and warm, and a little digusting. You watch it munch the leaves happily.</p><p></p><p>As you reach for another handful of leaves, you hear a snap and are suddenly falling. The branch has broken! You cry out in surprise as the ground rushes up to meet you, and close your eyes. A fall from that height will surely be fatal. So long, cruel world.</p><p></p><p>When you open your eyes again, you are floating in the air, suspended by the collar of your pajamas. The giraffe has caught you in its mouth! It lowers you safely to the ground, and you feed it the rest of the leaves.</p>"},
    {name:"MAASAI MARA", article:"", description:"While wandering around in Kenya's amazing Masaai Mara national game reserve, you see a cloud of dust on the horizon, followed by the thunderous sound of thousands of hooves approaching at a run.</p><p>\"It's the annual wildebeest migration!\" someone says.</p><p>This a yearly event, in which two million wildebeest, gazelles, and zebras travel from Serengeti National Park to Masaai Mara, then back again when the weather changes. Tourists come from all over the world to catch a glimpse of this parade of ruminants on the move.</p><p>You hear a scream.</p><p>\"They're going to trample that baby!\"</p><p>You look over to see an infant, unaware of the danger, playing on the ground directly in the path of the rampaging wildebeests. There's no time to wait: you sprint across the open ground, grab the baby, and leap into the air right at the instant the lead wildebeest would have crushed it beneath its hooves. </p><p>You ride the wildebeest, steering it by gripping its long, beautiful black mane, and return the baby to its mother. Then you and the wildebeest continue on, toward the fertile feeding grounds to the south.</p><p>"},
    ],
  },
  {
    area: "Kiribati",
