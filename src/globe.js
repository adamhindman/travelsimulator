    ...
    objects: [
      {
        ...
        description:
          ...
          "Then it hits you: you've actually traveled back in time to the history of the Fortress of Luxembourg!</p><p>You discover that it is 1714, and the Dutch are in control of the fortress. You become friends with the Dutch commander, and, over the next 5 years, you tell him everything you can remember about science and history, right up until the 2020s.</p><p>The commander studiously records everything you say, and, consequently, the Dutch invent the atomic bomb in the 18th century, connect the world on the the Dutch Internet in 1820, and set up the colony of New Rotterdam in 1890... on planet Mars!</p><p>Or, at least that's what you explained to the paramedics who rush you to the hospital back in Luxembourg, after they carried you out on a stretcher. They said you had suffered a concussion, and that you weren't allowed to go to sleep. You let them know that Dutch scientists have already invented a pill to replace sleep.</p>",
      },
      {
        name: "ARDENNES",
        article: "The",
