export let globe = [
  ...
  },
  {
    ...
    objects:[
      {name:"WATER TOWERS", article:"", description:"Millions of gallons of precious water are stored at each of the six sites where these tall, striped, mushroom shaped structures stand in clusters across Kuwait City. In the daytime, they act like giant beach umbrellas, casting shade on the happy people strolling under them.</p><p>You join a good-natured gang of teen athletes who secretly climbs the towers at night, to play half-court basketball under the watchful light of the silvery crescent moon.</p><p>The climb up the pronounced concave surface is hard, but worth it.</p><p>You slam a dunk so hard it makes the water inside the tower slosh back and forth like a swimming pool after someone did a cannonball into it.</p>"},
      {name:"KUWAIT SPACE ROCKET", article:"The", description: "A 4-meter long unmanned rocket, created right here in Kuwait. When it is launched, it will travel 100km up, to suborbital altitudes.</p><p>\"Every space program has to start somewhere,\" the project lead tells you.</p>"},
      // {name:"", article:"", description:""}
    ],
  },
  {
