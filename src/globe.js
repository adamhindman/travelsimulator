    ...
    objects: [
      {
        ...
        article: "The",
        description:
          "<p>You focus your attention on the dawn of the universe, as well as the moment it collapses into nothingness again.</p><p>You notice that there are a few other beings standing outside time to  watch these momentous events, and you try to start a wave, like at a baseball game. Disappointingly, there are only a couple of takers.</p><p>At the same time, you witness all previous and future universes too. There's a lot to say, and I can't get into details about it all here or it would take all day. Suffice it to say, the universe is basically a giant lung, and its cyclic expansion and retraction is just the slow breathing of a system so vast that imagining it makes you have to sit down for a while.</p>",
      },
      {
        name: "UNMOVED MOVER",
        article: "The",
      ...
      },
      {
        ...
        article: "A",
        description:
          "<p>You notice a small, handheld teleporter on the \'ground\'<sup>1</sup> here. It has a rotary dial with every country on Earth printed on it in small but readable letters, and it looks like you could turn the dial to any of them to select it.</p><p>In a triumph of user-centered design, the device has a single, intuitive button that just says TELEPORT on it.</p><p><sup>1</sup><span class=\"dim\">&nbsp;Cards on the table: it's not the ground, <em>per se</em>, since there is no up or down in this space (which isn\'t a place anyway), nor are there any solid, tangible surfaces for it to be \'on\'. The simplest way to put it would be that the teleportation device only exists as a cloud of overlapping probability manifolds that you can reach out and collapse to <em>understand</em> that a teleportation device was always there. If you choose to do it. Which you do.</p></span>",
        inventoryItem: {
          name: "Handheld Teleporter",
          description:
            "You got this sleek, minimalist teleportation device from a transdimensional nexus you went to. It's so well designed, all you have to do is type \`TELEPORT [Country]\` and you'll go there, as long as the country is a real place and not any kind of nexus.",
        },
      },
      {
        name: "ALIENS FUCKING",
      ...
      },
      {
        ...
        article: "",
        description:
          "It turns out this number is not irrational or infinitely long after all, it's just so large that it takes all of the information in about fifty different universes to write it down. You are pleased to see that its final digit is four.",
        notebookEntry: "4",
      },
    ],
  },
    ...
    objects: [
      {
        ...
        article: "",
        description:
          "<p>You set out to explore Atlantis, a city that is more than a mile under the ocean.</p><p>\'Things are a little different here,\' you will write to your mom, later. \'Instead of a knife and fork, here they eat with a knife and trident. Instead of cell phones, they have shell phones, and if you want to go somewhere fast, you just hop on the nearest whale!\'</p><p>Not being in a hurry, you simply watch the whales as they swim past you with massive, almost lazy swishes of their huge tails.</p><p>You discover that the main thoroughfare here is a long, wide, curving road called Nautilus Way, which spirals gently and concentrically toward the Palace of Poseidon, the city's seat of government. Nautilus Way is criss-crossed by numerous smaller streets, lined with residences and inviting little shops selling all manner of trinkets.</p><p>The streets are paved with large, squarely-fitted slabs of aquamarine and turquoise, decorated here and there with colorful agates, pearls, emeralds, and cut diamonds. Floating orbs of light bob up and down in the gentle current, casting dusky blue-green light that is just bright enough to read by.</p><p>At first, trying to walk is difficult, because you have to work hard not to float upwards with every step.</p><p>Seeing your troubles, a local merwoman patiently points out the nearest ballast station, where you fill your pockets with fistfuls of heavy lead shot that weigh you down enough to make walking easier.</p><p>\'If you ever lose your bearings,\' she adds, \'just swim up until you see where you want to go. By the way, where are you from?\'</p><p>You explain that you're from the surface, and you're just visiting.</p><p>\'I already figured that out,\' she chuckles.</p><p>After chatting for a few minutes about sports, you turn down Reef street, and pass by Seafoam Square to watch a band of rock lobsters who are busking for the happy passers-by. Merfolk on their way to work stop to listen to a song, and toss a doubloon or a cockleshell into an overturned diver's helmet, where a heap of donations is already piling up. You feel a swell of generousity, and impulsively toss them a few sand dollars. The lead singer winks an eye stalk at you without missing a beat.</p><p>You feel a gentle tug on your shirt sleeve. Turning around, you see a little octopus swimming in excited little circles. Its head is about the size of a cupcake, and it has a number of long, wavy tentacles that it uses to propel itself against the undersea currents. Its large, expressive eyes are trembling, as though on the verge of crying.</p><p>\'What's the matter, little guy?\'</p><p>You soon discover that the little octopus is lost, and is trying to find its home. You take one of its tentacles in your hand, and empty your pockets of the lead shot, which you know will be cleaned up by well paid, unionized municipal hermit crabs. Your heart melts when you feel the octopus\'s tiny suckers grasping to your palm for reassurance.</p><p>You take the baby octopus higher and higher into the city, until it is able to identify its neighborhood, less than half a league away.</p><p>Its parents, already frantically searching for their child, are so thankful for your help that they offer you a reward. You refuse, but accept their offer to eat dinner at their home, which is an old sunken galleon.</p><p>\'Nice place,\' you say, leaning back in your chair after a delicious meal of raw shrimp. \'Looks like you've done a lot of work on it.\'</p><p>Little Otto—that turns out to be the baby's name—is capering around on the ceiling, happily pretending to be a whale bus carrying loads of passengers.</p><p>\'Yeah,\' says the father, Magnus, \'I did a lot of the work myself. I originally hired a contractor. A couple squids.\' You detect a note of derision. \'But then I realized, hey, I\'ve got eight good arms, maybe I can save a little money, you know?\'</p><p>Later that night, pockets heavy, slightly buzzed on sea weed, you stagger back to your hostel feeling warm and content. What a great day in Atlantis!</p>",
      },
      {
        name: "POSEIDON",
        article: "The god",
        description:
          '<p>You sacrifice a white bull in order to secure an audience with the city\'s ruler, King Poseidon, in his lavish throne room in the palace.</p>The king has a long beard, and his well-muscled chest is bare. He is holding a large, ornate trident, and you get the sense that he really loves that thing.</p><p>"What boon seekest ye, oh man of the dry earth, who beggeth favor from the Wave Rider, Maker of Horses, Wielder of the Golden Trident [the king wiggles the trident for emphasis], Father of Nymphs, Brother to Olympian Zeus, the Eternal Sea Lord Poseidon?"</p>"Hear me, dark-haired lord of the deep, son of Kronos, who rules the sea and encircles the land," you begin...</p>',
      },
      {
        name: "ATLANTEAN TRIAL",
        article: "The",
        description:
          '<p>At the far end of Nautilus Way, you spot an unusually large structure, seemingly carved from a single enormous crystal about the size of a tennis court.</p><p>You ask a local dolphin what this building is, and they tell you it\'s a sacred temple built to house holy artifacts and fulfill a prophesy so old that it predates the fall of Atlantis itself.</p><p>Your interest picqued, you decide to swim in through the porthole-shaped door, and find a massive, irregularly-shaped room filled with light. The walls, floor, and ceiling of the room all seem to glow from within, in faint pink, purple, blue, and green that quivers, reminding you of the northern lights over Siberia. Small silver fish, swimming through the room, reflect the light like living disco balls. They flee in alarm as you swim through their paths.</p><p>Atop a set of coral stairs is a large platform, supporting an even larger, raised dais made of the palest white stone you\'ve ever seen. Its flat surface is wide enough to park a car on, and has a number of depressions carved into it. Each cavity looks like it\'s made to fit an object with a different size and shape.</p><p>Some sort of priest in green robes approaches you. Instead of swimming, he scuttles across the floor on several sets of legs. He extends a claw, and you very carefully shake it.</p><p>"Seventeen treasures were lost to the surface world when the ocean swallowed our realm," he tells you. "Seventeen objects which throb with unearthly power, scattered over the globe, awaiting the fortunate day when the prophesy is fulfilled at last."</p><p>"What\'s the prophesy?" you ask.</p><p>"That the treasures will be returned."</p><p>"What happens after?"</p><p>"I\'m out of a job, presumably," he says, "but I don\'t see it getting done any time soon. It would take a traveler of incredible talent and persistence to find them all."</p>',
        notebookEntry:
          "A giant crab man in Atlantis gave me a quest to find all 17 objects that glow with unearthly power. He said if I get stuck, I can ask POSEIDON for help. {{THROBBER_COUNT}}",
  ...
  },
  {
    ...
    objects: [
      ...
      },
      {
        ...
        article: "",
        description:
          'As the first feature-length narrative film ever produced, all subsequent films derive their power from it. Perhaps that\'s why this box of old film cannisters <span class="glow">throbs with unearthly power</span>.',
        inventoryItem: {
          name: "A film cannister",
          questline: "throbbers",
          description:
            "You took one of the film cannisters containing The Story of the Kelly Gang, part of Australia's rich heritage. It's hard to imagine why they'd mind you looting it, since it's available for streaming on ABC iView for Christ's sake.",
        },
      },
      {
        name: "KOOKABURRA",
  ...
  },
  {
    ...
    objects: [
      ...
      },
      {
        ...
        article: "",
        description:
          "<p>You are invited to tour the world headquarters of Coofandy, a factory direct online retailer specializing in cutting edge fashion at affordable prices. The building where their headquarters is located is apparently a big, rusting warehouse outside Guangzhou, in southern China.</p><p>Two stray dogs yawn at you from the corner of the parking lot.</p><p>Today\'s wardrobe: an asymmetrical corduroy turtleneck in wine red, with white Jacquard textured pants, complemented by a wide camelhair fedora that you think makes you look cool and exotic, like an international spy.</p><p>\"Hey, nice threads! I see you\'re a customer.\"</p><p>Instantly recognizing the voice of Oliver Chen, Coofandy\'s energetic, visionary CEO, you turn to shake his hand.</p><p>Chen is in his mid 30s, tall and fit, with a square jaw and immaculately trimmed hair, which looks even shinier and cleaner than other hair you\'ve seen. You notice he\'s dressed in a tailored suit that, unlike the clothes his company makes, is not for sale on Amazon.com. His grip is firm, his eye contact steady, his smile warm, but you sense captive strength. Here is a gentle lion, you think.</p><p>He explains that most of the staff are on a team-building retreat, which means the tour will have to wait. The offices inside the warehouse attest to this: a secretary at the front desk greets you both as you enter the building, but most of the offices are empty.</p><p>\"Alternatively, how about you join me for cigars in my office, and I can answer any questions you have about the company?\"</p><p>The traveler\'s credo: never turn down an offer for one-on-one time with a fascinating character. You nod and follow Chen into his office.</p><p>An hour later, you\'re on your second cigar, and now there\'s a scotch glass in your hand. You\'re still chatting with Chen, whom you find personable and transparent when it comes to your questions: it turns out, making clothes <em>is</em> fun, the biggest challenge to scaling the brand has been diversiying its retail channels, and the clothing models aren\'t just people who work at the office.</p><p>\"They\'re actually a mixture of real models sourced from agencies, and computer-generated non-entities who don\'t have to be paid at all, unlike real actors. And models.\"</p><p>He asks you some questions, too: he wants to know how many countries you\'ve visited, and some of the things you\'ve seen in your travels. He gives you some very basic puzzles to solve, too, mostly spatial reasoning and lateral thinking. He asks what you think about the current government of your country.</p><p>It\'s getting harder to answer his questions, since you can\'t help nodding off every few seconds. Your eyes just don\'t want to stay open.</p><p>\"Why are the windows dark? Is it nighttime—\" you start to ask.</p><p>When you wake up again, you\'re lying on a table in a white room. A speaker in the wall is talking to you in Chinese. Your arms and legs are secured with straps. You can feel the presence of someone else in the room, but you can\'t see them.</p><p>Then you\'re standing in line with a group of other people—all staring blankly, like they're asleep—and receiving what you\'re told are harmless vaccine injections. You tell them you\'re up to date on vaccinations, but this just makes them vaccinate you twice as hard.</p><p>Then you\'re on your feet, standing in a large concrete room. A strobe light is flashing in your eyes. You\'re holding a pistol and waiting for a target to pop up down range.</p><p>Then you\'re in the woods, running from the sound of barking dogs. You don\'t know exactly where you are, but based on the terrain and the foliage, you guess you\'re nowhere near Guangzhou.</p><p>\"This isn\'t part of the Coofandy tour,\" you think. But there\'s no time to consider your predicament in detail, because the dogs are getting closer and you can see the sweep of flashlight beams in the forest behind you. Your pursuers are so close that you can hear one of them instructing the others to cut you off at the Zijialing Bridge.</p><p>\"Zijialing Bridge? But that must mean I\'m... in Qinghe District, outside Kaiyuan. That\'s 1800 kilometers from Guangzhou, near the Yellow Sea. How\'d I get all the way up here?\"</p><p>Using your knowledge of world geography, you avoid the ambush at the bridge and turn south toward the Qinghe reservoir instead. To throw off the dogs, you swim across the reservoir. Shivering, and suddenly very hungry, you hide in the back of a passing truck bound for nowhere, just to make some distance. Over the course of several months you make your way back to Guangzhou, mostly sleeping in sheds and abandoned buildings to avoid being seen.</p><p>On the rare nights you can sleep, the unseen man in the white room is standing behind you in every fleeting dream. When you wake up, you have to fight your instinct to turn around.</p><p>The next time you next meet \'Oliver Chen\', it is in a dingy, fourth-floor apartment in the city. He enters into the dark room where you are already waiting.</p><p>\"My name isn\'t Oliver Chen. I\'m not the CEO of Coofandy. I don\'t even work for them, I swear.\" he says. \"They hired me to pretend to be him. To lure you to that building. Coofandy has nothing to do with this. Please, just don\'t point your gun at me. Your hand is shaking. At least take your finger off the trigger!\"</p><p>What happened to you at the facility in Qinghe, and why? Did you escape, or did they just let you think you got away? Is it fun to be the CEO of a clothing company? What were some challenges in scaling Coofandy\'s online presence and customer base? Are the clothes models from the website just regular employees that put on the clothes, and then they take their pictures?</p><p>Your mind swims with questions, all unanswered. A school of little fishes darting away from the light.</p><p>One thing\'s for sure, it\'s been an unforgettable trip to the beautiful city of Guangzhou, China, home of such famous attractions as the Canton Tower and the Guangdong Leopards baseball team.</p>",
      },
    ],
    type: "country",
    neighbors: [
  ...
  },
  {
    ...
    objects: [
      ...
      },
      {
        ...
        article: "",
        description:
          "Gotta write this https://en.wikipedia.org/wiki/Devil%27s_Island#Henri_Charri%C3%A8re_and_Sylvain",
      },
      {
        name: "Carnival",
        article: "",
        description:
          "gotta write this https://en.wikipedia.org/wiki/Carnival_in_French_Guiana",
      },
    ],
  },
  {
